...
1. [Python](https://www.python.org/ "https://www.python.org/") (3.7 or greater) with [numpy](https://numpy.org/, "https://numpy.org/"), [scipy](https://www.scipy.org/, "https://www.scipy.org/"), and [numba](http://numba.pydata.org "http://numba.pydata.org/") packages. Here, we strongly recommend using [Anaconda](https://www.anaconda.com/ "https://www.anaconda.com/") which has all the required packages installed.
